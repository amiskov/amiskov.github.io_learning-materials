...
`css-loader` сделает возможной подгрузку CSS-модуля (обернет CSS-файл в js). Содержимое будет можно будет зареквайрить, сохранить в переменную, но стиль не применится.
...
Любые подключения шрифтов и картинок в CSS-файлах Вебпак рассматривает как подключение модулей, поэтому без соответствующих лоадеров не обойтись.
